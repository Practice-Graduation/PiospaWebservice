...
(function($) {
	...
	$.fn.fileuploader.defaults = {
        ...
        captions: {
            ...
            removeConfirmation: 'Bạn có muốn xóa file này không?',
            errors: {
                filesLimit: 'chỉ những file ${limit} được phép upload.',
                filesType: 'Chỉ những file ${extensions} được phép upload.',
                fileSize: '${name} quá lớn! Vui lòng chọn file có kích thước bé h ${fileMaxSize}MB.',
                filesSizeAll: 'Kích thước file quá lớn! Vui lòng upload file có kích thước tối đa là ${maxSize} MB.',
                fileName: 'File ${name} đã được chọn.',
                folderUpload: 'Không được phép upload folder.'
            }
        }
	}
})(jQuery);