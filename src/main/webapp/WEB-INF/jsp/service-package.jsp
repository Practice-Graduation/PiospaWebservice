...
<body class="hold-transition skin-blue sidebar-mini">
	...
	<c:set var="currentPage" value="pageServicePackageList" scope="request"/>
	<div class="wrapper">
				...
				<div class="col-md-12">
					<div class="box">
						<div class="box-header">
							<h3 class="box-title">DANH SÁCH GÓI DỊCH VỤ</h3>
						</div>
						<!-- /.box-header -->
						<div class="box-body">
							<table id="example1" class="table table-bordered">
								...
								<tbody>
									<c:forEach var="p" items="${result}">
										<tr id="${p.servicePackageId }">
											<td style="text-align: center; vertical-align: middle;width: 10px;">${p.servicePackageId}</td>
											<td style="width: 100px;" class="post-img"><img
												src="${p.image}" alt="${p.image }" width="80px"
												height="100px"></td>
											<td style="text-align: center; vertical-align: middle;width: 150px;">${p.servicePackageName}</td>
											<td style="text-align: center; vertical-align: middle;width: 65px;">${p.time }</td>
											...
											<td style="text-align: center; vertical-align: middle;">
												<div class="btn-group-vertical">
													<a class="btn btn-info"
														href="${pageContext.request.contextPath }/admin/edit-service-package/${p.servicePackageId}"><i
														class="fa fa-pencil-square-o"></i></a>
													<button type="button" product-name="${p.servicePackageName}"
														product-id="${p.servicePackageId}"
								...
								$('#btn-remove-product-from-list')
										.click(
												function() {
													...
													$
															.ajax({
																url : "${pageContext.request.contextPath}/admin/remove-service-package",
																type : "get",
